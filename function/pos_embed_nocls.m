classdef pos_embed_nocls < nnet.layer.Layer
    ...
    methods
        ...
        function layer = pos_embed_nocls (Name, embed_dim, image_size, patch_size)
            ...
            layer.Description = "pos_embed_nocls";
